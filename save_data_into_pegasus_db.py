...
class SaveDataIntoPegasusDatabase(JinjaTemplating):
    ...
    def get(self):
        formId = 'Aliu'
        self.set_url_for_aggregate_publish(formId)
        return
    ...
    def set_url_for_aggregate_publish(self,formId):

        url_to_post_to = "https://kaygee-odk-test.appspot.com/aggregateui/formservice"

        self.response.out.write("You are about to set url")
