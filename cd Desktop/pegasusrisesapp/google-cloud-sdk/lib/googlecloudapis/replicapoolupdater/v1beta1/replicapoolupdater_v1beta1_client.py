...
class ReplicapoolupdaterV1beta1(base_api.BaseApiClient):
  ...
  class UpdatesService(base_api.BaseApiService):
    ...
    def __init__(self, client):
      ...
      self._method_configs = {
          ...
          'Resume': base_api.ApiMethodInfo(
              http_method=u'POST',
              method_id=u'replicapoolupdater.updates.resume',
              ordered_params=[u'project', u'zone', u'instanceGroupManager', u'update'],
              path_params=[u'instanceGroupManager', u'project', u'update', u'zone'],
              query_params=[],
              relative_path=u'projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/updates/{update}/resume',
              request_field='',
              request_type_name=u'ReplicapoolupdaterUpdatesResumeRequest',
              response_type_name=u'ReplicapoolupdaterUpdatesResumeResponse',
              supports_download=False,
          ),
    ...
    def ListInstanceUpdates(self, request, global_params=None):
      """Called on the particular Update endpoint. Lists instance updates for a given update.
    ...
    def Resume(self, request, global_params=None):
      """Called on the particular Update endpoint. Resumes the update in state PAUSED. No-op if invoked in state ROLLING_FORWARD or ROLLING_BACK.

      Args:
        request: (ReplicapoolupdaterUpdatesResumeRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (ReplicapoolupdaterUpdatesResumeResponse) The response message.
      """
    ...
    def Rollforward(self, request, global_params=None):
      """Called on the particular Update endpoint. Rolls forward the update in state PAUSED before ordering it to roll back. No-op if invoked in state ROLLED_OUT or ROLLING_FORWARD.
